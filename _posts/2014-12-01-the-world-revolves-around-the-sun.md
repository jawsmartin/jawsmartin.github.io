...
Aggrego, the company I was technically employed by for this project, is a software development startup that  creates and manages large, news media networks across website and mobile apps.

It is one of many businesses, along with Chicago Sun-Times, that is owned (or heavily invested by) Wrapports, LLC. Others include Pioneer Press, High School Cube, Higi, Chicago Reader, and Splash.

Aggrego employees a small group of developers/engineers who rapidly build the news media networks from the ground up, as well as a larger group of content creators/managers who fill said networks with highly-monetizable content. 

{% include image.html name="intro" caption="Aggrego Tech Team working on Sun-Times Network" %}

During my tenure with Aggrego, our team worked on a wide range of inhouse projects, such as Weekaway, a travel website that helps you find the best regional travel destinations, and Rankommend, a local Chicago business directory.

However, a majority of our time was focused primarily on building for others. 

A few of our client projects include Sun-Times Media Group's Chicago suburb news network, Pioneer Press, Digicel's international news network, Loop, and Communicorp's multi-county Ireland news network, Today.ie.

The Sun-Times Network would be another of these client projects. 

It was proposed by Sun-Times Media Group's owner, Wrapports, LLC, as a one-off extention of the Chicago Sun-Times brand into Milwaukee, WI.

However, as we started mapping out the product it started to be apparent that the process for "Milwaukee Sun-Times" could be duplicated infinitely, assuming we could create a scalable template.
